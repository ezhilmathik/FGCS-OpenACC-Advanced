...
int main()
{
  ...
  _DOUBLE_ *d_T1_3 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T1_4 = NULL; // GPU partial data transfer
  ...
  _DOUBLE_ *d_T2_3 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T2_4 = NULL; // GPU partial data transfer
  ...
  _DOUBLE_ *d_T3_1 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T3_2 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T3_4 = NULL; // GPU partial data transfer
  ...
  _DOUBLE_ *d_T4_1 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T4_2 = NULL; // GPU partial data transfer
  _DOUBLE_ *d_T4_3 = NULL; // GPU partial data transfer
  ...
  cudaMalloc((void**)&d_T1_2, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T1_3, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T1_4, sizeof(_DOUBLE_) * breadth * block * width);
  ...
  cudaMalloc((void**)&d_T2_1, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T2_3, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T2_4, sizeof(_DOUBLE_) * breadth * block * width);
  ...
  cudaMalloc((void**)&d_T3_1, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T3_2, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T3_4, sizeof(_DOUBLE_) * breadth * block * width);
  ...
  cudaMalloc((void**)&d_T4_1, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T4_2, sizeof(_DOUBLE_) * breadth * block * width);
  cudaMalloc((void**)&d_T4_3, sizeof(_DOUBLE_) * breadth * block * width);
  ...
  // halo stream top and bottoms or (left and right)
  cudaStream_t halo_stream[numberofgpus];
  cudaStream_t halo_stream_[numberofgpus];

  // data transfer stream (packing and unpacking)
  cudaStream_t copy_stream[numberofgpus];

  // data transfer streams (cudaMemcpyPeerAsync streams)
  cudaStream_t copy_stream_1[numberofgpus];
  cudaStream_t copy_stream_2[numberofgpus];
  cudaStream_t copy_stream_3[numberofgpus];
  ...
  for (int i = 0; i < numberofgpus; ++i) 
    {
      ...
      cudaStreamCreate(&copy_stream_1[i]);
      cudaStreamCreate(&copy_stream_2[i]);
      cudaStreamCreate(&copy_stream_3[i]);
    }
...
#pragma omp barrier 
	...
	if (tid == 0)
	  {	    
	    cudaSetDevice(0);
	    from_k_to_y_direction_T1<<< data_G, data_B, 0, copy_stream[0] >>>(c_T1, c_T1_1, c_T1_2, 
									      c_T1_3, c_T1_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[0]);
	    cudaMemcpyPeerAsync(d_T2_1, 1, c_T1_2, 0, data_size, copy_stream_1[0]);
	    cudaMemcpyPeerAsync(d_T3_1, 2, c_T1_3, 0, data_size, copy_stream_2[0]);
	    cudaMemcpyPeerAsync(d_T4_1, 3, c_T1_4, 0, data_size, copy_stream_3[0]);
	  }
	...
	if (tid == 1)
	  {	    
	    ...
	    cudaSetDevice(1);
	    from_k_to_y_direction_T2<<< data_G, data_B, 0, copy_stream[1] >>>(c_T2, c_T2_1, c_T2_2, 
									      c_T2_3, c_T2_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[1]);
	    cudaMemcpyPeerAsync(d_T1_2, 0, c_T2_1, 1, data_size, copy_stream_1[1]);
	    cudaMemcpyPeerAsync(d_T3_2, 2, c_T2_3, 1, data_size, copy_stream_2[1]);
	    cudaMemcpyPeerAsync(d_T4_2, 3, c_T2_4, 1, data_size, copy_stream_3[1]);	    
	  }

	if (tid == 2)
	  {	    
	    cudaSetDevice(2);
	    from_k_to_y_direction_T3<<< data_G, data_B, 0, copy_stream[2] >>>(c_T3, c_T3_1, c_T3_2, 
									      c_T3_3, c_T3_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[2]);
	    cudaMemcpyPeerAsync(d_T1_3, 0, c_T3_1, 2, data_size, copy_stream_1[2]);
	    cudaMemcpyPeerAsync(d_T2_3, 1, c_T3_2, 2, data_size, copy_stream_2[2]);
	    cudaMemcpyPeerAsync(d_T4_3, 3, c_T3_4, 2, data_size, copy_stream_3[2]);	    
	  }

	if (tid == 3)
	  {
	    cudaSetDevice(3);
	    from_k_to_y_direction_T4<<< data_G, data_B, 0, copy_stream[3] >>>(c_T4, c_T4_1, c_T4_2, 
									      c_T4_3, c_T4_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[3]);
	    cudaMemcpyPeerAsync(d_T1_4, 0, c_T4_1, 3, data_size, copy_stream_1[3]);
	    cudaMemcpyPeerAsync(d_T2_4, 1, c_T4_2, 3, data_size, copy_stream_2[3]);
	    cudaMemcpyPeerAsync(d_T3_4, 2, c_T4_3, 3, data_size, copy_stream_3[3]);
	  }
...
#pragma omp barrier 
	...
	if (tid == 0)
	  {
            cudaSetDevice(1);
            cudaStreamSynchronize(copy_stream_1[1]);
            cudaSetDevice(2);
            cudaStreamSynchronize(copy_stream_1[2]);
            cudaSetDevice(3);
            cudaStreamSynchronize(copy_stream_1[3]);
	    cudaSetDevice(0);
	    to_k_to_y_direction_T1<<< data_G, data_B, 0, copy_stream[0] >>>(c_T1, c_T1_1, d_T1_2, 
									    d_T1_3, d_T1_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[0]);
	  }
	...
	if (tid == 1)
	  {	
	    cudaSetDevice(0);
            cudaStreamSynchronize(copy_stream_1[0]);
            cudaSetDevice(2);
            cudaStreamSynchronize(copy_stream_2[2]);
            cudaSetDevice(3);
            cudaStreamSynchronize(copy_stream_2[3]);
	    cudaSetDevice(1);
	    to_k_to_y_direction_T2<<< data_G, data_B, 0, copy_stream[1] >>>(c_T2, d_T2_1, c_T2_2, 
									    d_T2_3, d_T2_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[1]);    
	  }
	...
	if (tid == 2)
	  {	 
            cudaSetDevice(0);
            cudaStreamSynchronize(copy_stream_2[0]);
            cudaSetDevice(1);
            cudaStreamSynchronize(copy_stream_2[1]);
            cudaSetDevice(3);
            cudaStreamSynchronize(copy_stream_3[3]);
	    cudaSetDevice(2);
	    to_k_to_y_direction_T3<<< data_G, data_B, 0, copy_stream[2] >>>(c_T3, d_T3_1, d_T3_2, 
									    c_T3_3, d_T3_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[2]);	    
	  }
	...
	if (tid == 3)
	  {
            cudaSetDevice(0);
            cudaStreamSynchronize(copy_stream_3[0]);
            cudaSetDevice(1);
            cudaStreamSynchronize(copy_stream_3[1]);
            cudaSetDevice(2);
            cudaStreamSynchronize(copy_stream_3[2]);
	    cudaSetDevice(3);
	    to_k_to_y_direction_T4<<< data_G, data_B, 0, copy_stream[3] >>>(c_T4, d_T4_1, d_T4_2, 
									    d_T4_3, c_T4_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[3]);
	  }     
#pragma omp barrier
	//////////////////// data transfer-> shuffling //////////////////////////////////////////////////////////////////////
...
#pragma omp barrier
	...
	if (tid == 0)
	  {
	    cudaSetDevice(0);
	    from_y_to_k_direction_T11<<< data_G, data_B, 0, copy_stream[0] >>>(c_T1, c_T1_1, c_T1_2, 
									       c_T1_3, c_T1_4, block, width, breadth);
	    cudaMemcpyPeerAsync(d_T2_1, 1, c_T1_2, 0, data_size, copy_stream_1[0]);
	    cudaMemcpyPeerAsync(d_T3_1, 2, c_T1_3, 0, data_size, copy_stream_2[0]);
	    cudaMemcpyPeerAsync(d_T4_1, 3, c_T1_4, 0, data_size, copy_stream_3[0]);
	...
	if (tid == 1)
	  {
	    cudaSetDevice(1);
	    from_y_to_k_direction_T21<<< data_G, data_B, 0, copy_stream[1] >>>(c_T2, c_T2_1, c_T2_2, 
									       c_T2_3, c_T2_4, block, width, breadth);
	    cudaMemcpyPeerAsync(d_T1_2, 0, c_T2_1, 1, data_size, copy_stream_1[1]);
	    cudaMemcpyPeerAsync(d_T3_2, 2, c_T2_3, 1, data_size, copy_stream_2[1]);
	    cudaMemcpyPeerAsync(d_T4_2, 3, c_T2_4, 1, data_size, copy_stream_3[1]);
	...
	if (tid == 2)
	  {
	    ...
	    cudaSetDevice(2);
	    from_y_to_k_direction_T31<<< data_G, data_B, 0, copy_stream[2] >>>(c_T3, c_T3_1, c_T3_2, 
									       c_T3_3, c_T3_4, block, width, breadth);
	    cudaMemcpyPeerAsync(d_T1_3, 0, c_T3_1, 2, data_size, copy_stream_1[2]);
	    cudaMemcpyPeerAsync(d_T2_3, 1, c_T3_2, 2, data_size, copy_stream_2[2]);
	    cudaMemcpyPeerAsync(d_T4_3, 3, c_T3_4, 2, data_size, copy_stream_3[2]);
	...
	if (tid == 3)
	  {
	    ...
	    cudaSetDevice(3);
	    from_y_to_k_direction_T41<<< data_G, data_B, 0, copy_stream[3] >>>(c_T4, c_T4_1, c_T4_2, 
									       c_T4_3, c_T4_4, block, width, breadth);
	    cudaMemcpyPeerAsync(d_T1_4, 0, c_T4_1, 3, data_size, copy_stream_1[3]);
	    cudaMemcpyPeerAsync(d_T2_4, 1, c_T4_2, 3, data_size, copy_stream_2[3]);
	    cudaMemcpyPeerAsync(d_T3_4, 2, c_T4_3, 3, data_size, copy_stream_3[3]);
...
#pragma omp barrier
	...
	if (tid == 0)
	  {
            ...
            cudaStreamSynchronize(copy_stream_1[3]);
	    cudaSetDevice(0);
	    to_y_to_k_direction_T11<<< data_G, data_B, 0, copy_stream[0] >>>(c_T1, c_T1_1, d_T1_2, 
									     d_T1_3, d_T1_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[0]);
	  }
	...
	if (tid == 1)
	  {
	    cudaSetDevice(0);
            ...
            cudaStreamSynchronize(copy_stream_2[3]);
	    cudaSetDevice(1);
	    to_y_to_k_direction_T21<<< data_G, data_B, 0, copy_stream[1] >>>(c_T2, d_T2_1, c_T2_2, 
									     d_T2_3, d_T2_4, block, width, breadth);  
            cudaStreamSynchronize(copy_stream[1]);
	  }
	...
	if (tid == 2)
	  {	
            ...
            cudaStreamSynchronize(copy_stream_3[3]);
	    cudaSetDevice(2);
	    to_y_to_k_direction_T31<<< data_G, data_B, 0, copy_stream[2] >>>(c_T3, d_T3_1, d_T3_2, 
									     c_T3_3, d_T3_4, block, width, breadth);
            cudaStreamSynchronize(copy_stream[2]);	
	  }
	...
	if (tid == 3)
	  {
            ...
            cudaStreamSynchronize(copy_stream_3[2]);
	    cudaSetDevice(3);
	    to_y_to_k_direction_T41<<< data_G, data_B, 0, copy_stream[3]>>>(c_T4, d_T4_1, d_T4_2, 
									    d_T4_3, c_T4_4, block, width, breadth);    
            cudaStreamSynchronize(copy_stream[3]); 
	  }
#pragma omp barrier
  ...
  cudaFree(d_T1_2); cudaFree(d_T1_3); cudaFree(d_T1_4);
  cudaFree(d_T2_1); cudaFree(d_T2_3); cudaFree(d_T2_4);
  cudaFree(d_T3_1); cudaFree(d_T3_2); cudaFree(d_T3_4);
  cudaFree(d_T4_1); cudaFree(d_T4_2); cudaFree(d_T4_3);
...
#ifdef PRI
  FILE *init;
  init = fopen("p2p_omp_an_iso_4_gpu.txt","w");
  for(i = 0; i < block; i++)
    {
      for(j = 0; j < block; j++)
	{
...
#ifdef PRI
  printf(" Solution is written in the file------------------------ p2p_omp_an_iso_4_gpu.txt \n");
#endif
  printf("*******************************************************************************************\n");
  return 0;
}
