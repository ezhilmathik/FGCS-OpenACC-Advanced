...
int main()
{
  ...
  _DOUBLE_ *restrict d_1_2 = NULL; //(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_1_3 = NULL; //(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_1_4 = NULL; //(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     

  _DOUBLE_ *restrict d_2_1 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_2_3 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_2_4 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     

  _DOUBLE_ *restrict d_3_1 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_3_2 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_3_4 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     

  _DOUBLE_ *restrict d_4_1 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_4_2 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  _DOUBLE_ *restrict d_4_3 = NULL;//(_DOUBLE_*)malloc(sizeof(_DOUBLE_) * breadth * block * width);     
  ...
  d_1_2 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_1_3 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_1_4 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  ...
  d_2_1 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_2_3 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_2_4 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);  
  ...
  d_3_1 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_3_2 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_3_4 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  ...
  d_4_1 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_4_2 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);
  d_4_3 = acc_malloc((size_t) sizeof(_DOUBLE_) * breadth * block * width);  
	...
	if (tid == 0)
	  {
	    ...
	    from_k_to_y_direction_T1(c_T1, c_T1_1, c_T1_2, c_T1_3, c_T1_4, block, width, breadth, 0, 0);
	    acc_wait_all();
	    acc_memcpy_device_async( d_2_1, c_T1_2, data_size, 1);
	    acc_memcpy_device_async( d_3_1, c_T1_3, data_size, 2);
	    acc_memcpy_device_async( d_4_1, c_T1_4, data_size, 3);	    
	  }
	if (tid == 1)
	  {
	    // copy GPU 2 data in to 2 buffers	    
	    from_k_to_y_direction_T2(c_T2, c_T2_1, c_T2_2, c_T2_3, c_T2_4, block, width, breadth, 1, 1);
	    acc_wait_all();
	    acc_memcpy_device_async( d_1_2, c_T2_1, data_size, 0);
	    acc_memcpy_device_async( d_3_2, c_T2_3, data_size, 2);
	    acc_memcpy_device_async( d_4_2, c_T2_4, data_size, 3);	   
	  }
	if (tid == 2)
	  {
	    // copy GPU 3 data in to 3 buffers             
	    from_k_to_y_direction_T3(c_T3, c_T3_1, c_T3_2, c_T3_3, c_T3_4, block, width, breadth, 2, 2);
	    acc_wait_all();
	    acc_memcpy_device_async( d_1_3, c_T3_1, data_size, 0);
	    acc_memcpy_device_async( d_2_3, c_T3_2, data_size, 1);
	    acc_memcpy_device_async( d_4_3, c_T3_4, data_size, 3);
	  }
	if (tid == 3)
	  {
	    // copy GPU 4 data in to 4 buffers             
	    from_k_to_y_direction_T4(c_T4, c_T4_1, c_T4_2, c_T4_3, c_T4_4, block, width, breadth, 3, 3);
	    acc_wait_all();
	    acc_memcpy_device_async( d_1_4, c_T4_1, data_size, 0);
	    acc_memcpy_device_async( d_2_4, c_T4_2, data_size, 1);	    
	    acc_memcpy_device_async( d_3_4, c_T4_3, data_size, 2);
	  }
	acc_wait_all();	
#pragma omp barrier
	...
	if (tid == 0)      
	  {
	    ...
	    to_k_to_y_direction_T1(c_T1, c_T1_1, d_1_2, d_1_3, d_1_4, block, width, breadth, 0, 0);
	  }
	if (tid == 1)
	  {
	    // copied data to GPU from CPU
	    to_k_to_y_direction_T2(c_T2, d_2_1, c_T2_2, d_2_3, d_2_4, block, width, breadth, 1, 1);
	  }
	if (tid == 2)
	  {      
	    // copied data to GPU from CPU
	    // mutilpe GPU biuffer in to 3 GPU
	    to_k_to_y_direction_T3(c_T3, d_3_1, d_3_2, c_T3_3, d_3_4, block, width, breadth, 2, 2);
	  }
	if (tid == 3)
	  {
	    // copied data to GPU from CPU
	    to_k_to_y_direction_T4(c_T4, d_4_1, d_4_2, d_4_3, c_T4_4, block, width, breadth, 3, 3);
	  }
	acc_wait_all();
#pragma omp barrier
	...
	if (tid == 0)
	  {
	    from_y_to_k_direction_T11(c_T1, c_T1_1, c_T1_2, 
				      c_T1_3, c_T1_4, block, width, breadth, 0, 0);
	    acc_wait_all();
	    start_data_timer_2 = omp_get_wtime();		    
	    acc_memcpy_device_async(d_2_1, c_T1_2, data_size, 1);
	    acc_memcpy_device_async(d_3_1, c_T1_3, data_size, 2);
	...
	if (tid == 1)
	  {
	    from_y_to_k_direction_T21(c_T2, c_T2_1, c_T2_2, 
				      c_T2_3, c_T2_4, block, width, breadth, 1, 1);
	    acc_wait_all();
	    acc_memcpy_device_async(d_1_2, c_T2_1, data_size, 0);
	    acc_memcpy_device_async(d_3_2, c_T2_3, data_size, 2);	    
	    acc_memcpy_device_async(d_4_2, c_T2_4, data_size, 3);	    
	...
	if (tid == 2)
	  {
	    from_y_to_k_direction_T31(c_T3, c_T3_1, c_T3_2, 
				      c_T3_3, c_T3_4, block, width, breadth, 2, 2);
	    acc_wait_all();
	    acc_memcpy_device_async(d_1_3, c_T3_1, data_size, 0);
	    acc_memcpy_device_async(d_2_3, c_T3_2, data_size, 1);	    
	    acc_memcpy_device_async(d_4_3, c_T3_4, data_size, 3);	    
	...
	if (tid == 3)
	  {
	    from_y_to_k_direction_T41(c_T4, c_T4_1, c_T4_2, 
				      c_T4_3, c_T4_4, block, width, breadth, 3, 3);
	    acc_wait_all();
	    acc_memcpy_device_async(d_1_4, c_T4_1, data_size, 0);
	    acc_memcpy_device_async(d_2_4, c_T4_2, data_size, 1);	    
	    acc_memcpy_device_async(d_3_4, c_T4_3, data_size, 2);
...
#pragma omp barrier
	...
	if (tid == 0)
	  {
	    ...
	    //	    start_data_timer_2 = omp_get_wtime();		    
	    to_y_to_k_direction_T11(c_T1, c_T1_1, d_1_2, 
				    d_1_3, d_1_4, block, width, breadth, 0, 0);
	    //	    acc_wait_all();
	    //	    end_data_timer_2 = omp_get_wtime();
	    //	    data2 += (end_data_timer_2 - start_data_timer_2);	    	    
	  }
	if (tid == 1)
	  {	
	    // copied data from CPU to GPU
	    to_y_to_k_direction_T21(c_T2, d_2_1, c_T2_2, 
				    d_2_3, d_2_4, block, width, breadth, 1, 1);     
	  }
	if (tid == 2)
	  {
	    // copied data from CPU to GPU
	    to_y_to_k_direction_T31(c_T3, d_3_1, d_3_2, 
				    c_T3_3, d_3_4, block, width, breadth, 2, 2);
	  }
	if (tid == 3)
	  {
	    // copied data from CPU to GPU
	    to_y_to_k_direction_T41(c_T4, d_4_1, d_4_2, 
				    d_4_3, c_T4_4, block, width, breadth, 3, 3);
	  }
	acc_wait_all();
#pragma omp barrier
	//	end_data_timer_2 = omp_get_wtime();
  ...
  acc_free(d_1_2);acc_free(d_1_3);acc_free(d_1_4);
  acc_free(d_2_1);acc_free(d_2_3);acc_free(d_2_4);
  acc_free(d_3_1);acc_free(d_3_2);acc_free(d_3_4);
  acc_free(d_4_1);acc_free(d_4_2);acc_free(d_4_3);
...
#ifdef PRI
  FILE *init;
  init = fopen("p2p_omp_stream_an_iso_4_openacc.txt","w");
  for(i = 0; i < block; i++)
    {
      for(j = 0; j < block; j++)
	{
...
#ifdef PRI
  printf(" Solution is written in the file------------------------ p2p_omp_stream_an_iso_4_openacc.txt \n");
#endif
  printf("*******************************************************************************************\n");
  return 0;
}
